 ...
 * [05_testcase_reducing.py](https://github.com/NWU-NISL-Fuzzing/COMFORT/blob/main/artifact_evaluation/src/05_testcase_reducing.py): A demonstraction of the test case reduction.
...
### ★ Demonstraction of Test Case Reduction
To help developers in examining bug-exposing test cases, wedevelop a simple yet effective approach to reduce the sizeof a test case that triggers an anomalous compiler behavior。 You can use the following to execute our program reduction algorithm:
