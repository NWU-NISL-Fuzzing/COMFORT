...
Please note that this configurations were setup on **a host machine with Ubuntu OS**. It will throw exception when configuring in other Linux OS except Ubuntu. 
