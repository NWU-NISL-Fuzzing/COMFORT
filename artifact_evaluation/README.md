...
**While it is possible to create your own copy of our Jupyter Notebook usng [the code](https://github.com/NWU-NISL-Fuzzing/COMFORT/tree/main/artifact_evaluation/Jupyter) provided, we recommend to use the configured server as it is non-trivial to configure the Notebook locally within a docker container**. 
...
The main results of the paper are a [list of bugs](https://github.com/NWU-NISL-Fuzzing/COMFORT/blob/main/artifact_evaluation/Bug-List.md) exposed by COMFORT-generated test cases and other competing methods. 
...
For convience, we have provided the test data generated by other fuzzers. But you can still check [this document](https://github.com/NWU-NISL-Fuzzing/COMFORT/blob/main/artifact_evaluation/prior-fuzzers.md)  for how to use other fuzzers (CodeAlchemist, DeepSmith, Fuzzilli, Montage, DIE) for test program generation and differential testing. 
...
The docker image provides a small-scale experiment to showcase the working mechanism of our work. Our main results (that run much longer – 200 hours per JS testbed on a larger test dataset) can be found at the [Bug List](https://github.com/NWU-NISL-Fuzzing/COMFORT/blob/main/artifact_evaluation/Bug-List.md) section. 
...
Notes for how to resue our AE can be found at [this document](https://github.com/NWU-NISL-Fuzzing/COMFORT/blob/main/artifact_evaluation/ReuseNotes.md).
