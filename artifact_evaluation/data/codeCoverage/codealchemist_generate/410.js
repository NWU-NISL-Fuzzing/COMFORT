...
"use strict";
var v4 = v3(44), v5 = v4(({INSERT_MARKUP : null, MOVE_EXISTING : null, REMOVE_NODE : null, TEXT_CONTENT : null}));
(v1.exports) = v5;
});
var v2 = (function (v1, v2, v3){
var v4 = v1('./Language');
(v2.exports) = (function (){
var v5 = ({feature : '(?:[Tt]ale|[Yy]arn)', scenario : '(?:[Aa]dventure|[Ss]ortie)', examples : '[Ww]herest', pending : 'Brig', background : '[Aa]ftground', given : '(?:[Gg]iveth|[Ww]ith|[Aa]nd|[Bb]ut|[Ee]xcept)', when : '(?:[Ww]hence|[Ii]f|[Aa]nd|[Bb]ut)', then : '(?:[Tt]hence|[Ee]xpect|[Aa]nd|[Bb]ut)', _steps : [], get giveth(){
return this.given;
}, get whence(){
return this.when;
}, get thence(){
