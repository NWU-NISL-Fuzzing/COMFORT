...
var v7 = [];
var v8 = [];
var v9 = v1.furniture_pickup(v2.itemstack_tsid);
(v4) = ! v9.ok;
if(v9.error){
v6.push(v9.error);
}
var v10 = this.buildVerbMessage(v2.count, 'pick up', 'picked up', v4, v6, v7, v8);
if((! v3) && (v10)){
v1.sendActivity(v10);
}
return (v4) ? (false) : (true);
});
var v2 = (function (v1, v2, v3){
var v4 = v3(662), v5 = v3(1832), v6 = v3(330);
...
(v6) = [];
if(v2){
v6.push('padding-left', 'padding-right');
}
if(v3){
v6.push('margin-left', 'margin-right');
}
}else {
(v6) = [];
if(v2){
v6.push('padding-top', 'padding-bottom');
}
if(v3){
v6.push('margin-top', 'margin-bottom');
}
}
for(var v7 = (v6.length) - (1);(v7) >= (0);v7--){
(v5) += parseInt(v1.css(v6[v7]).replace('px', ''), 10);
}
return v5;
});
var v5 = (function (){
