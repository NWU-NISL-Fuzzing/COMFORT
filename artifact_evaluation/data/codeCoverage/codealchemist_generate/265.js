var v0 = (function (v1){
var v2 = ({className : "string", contains : [], variants : []});
return ({aliases : [], case_insensitive : true, illegal : /\S/, contains : []});
});
...
var v2 = (function (v1){
return v1('uibTooltipTemplate', 'tooltip', 'mouseenter', ({useContentExp : true}));
});
var v3 = (function (){
function v3(){
}
