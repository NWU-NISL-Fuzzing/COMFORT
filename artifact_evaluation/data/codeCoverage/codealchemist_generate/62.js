...
var v1 = ({});
var v2 = ({});
this.analyzeBlock(this.top, null, v1, v2);
});
(v0.asComment) = (function (v1){
...
this.bitmap.data.writeUInt32BE(this._background, v3);
});
}
...
for(var v4 = [], v5 = 0;(v5) < (v1.length);++v5){
(v4[v5]) = this.createMaterial(v1[v5], v2, v3);
}
return v4;
});
}
(v0.prototype) = ((v3) === (null)) ? (Object.create(v3)) : (((v5.prototype) = v3.prototype, new v5()));
