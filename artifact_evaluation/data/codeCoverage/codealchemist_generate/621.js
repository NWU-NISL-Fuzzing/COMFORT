...
var v1 = (function (v1){
var v2 = false;
v1.setMetric('timeToFirstByte');
v1.setMetric('timeToLastByte');
v1.on('recv', (function (v3, v4){
if(v2){
return;
}
if(v3.isRedirect){
v1.log('Time to first byte: <%s> is a redirect', v3.url);
return;
}
v1.setMetric('timeToFirstByte', v3.timeToFirstByte, true);
v1.setMetric('timeToLastByte', v3.timeToLastByte, true);
(v2) = true;
v1.log('Time to first byte: set to %d ms for request to <%s> (HTTP %d)', v3.timeToFirstByte, v3.url, v3.status);
v1.log('Time to last byte: set to %d ms', v3.timeToLastByte);
v1.emit('responseEnd', v3, v4);
}));
});
var v2 = (function (){
...
(v0.prototype) = Object.create(v2.prototype);
