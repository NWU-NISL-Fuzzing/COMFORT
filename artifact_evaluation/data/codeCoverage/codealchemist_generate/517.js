var v0 = (function (v1){
(v1.AnimationVector) = (function (v2){
(this.curves) = ({});
v1.Assets.registerAsset(this, v2);
});
v1.augment(v1.QuickNotation, v1.AnimationVector);
v1.augment(v1.JSONLoader, v1.AnimationVector);
(v1.AnimationVector.prototype.curves) = ({});
(v1.AnimationVector.prototype.frames) = 250;
(v1.AnimationVector.prototype.startFrame) = 0;
(v1.AnimationVector.prototype.addAnimationCurve) = (function (v3){
(this.curves[v3.channel]) = v3;
return this;
});
(v1.AnimationVector.prototype.removeAnimationCurve) = (function (v4){
delete this.curves[v4];
});
(v1.AnimationVector.prototype.setFrames) = (function (v5){
(this.frames) = v5;
return this;
});
(v1.AnimationVector.prototype.getFrames) = (function (){
return this.frames;
});
(v1.AnimationVector.prototype.setStartFrame) = (function (v5){
(this.startFrame) = v5;
return this;
});
(v1.AnimationVector.prototype.getStartFrame) = (function (){
return this.startFrame;
});
});
(v0.FORMATTING_ERROR) = 1;
var v1 = (function (v1){
return v1.properties;
});
var v2 = (function (v1){
return this._fromRadians(Math.acos(v1));
});
...
this._buildTree();
v1.prototype.expand.apply(this, arguments);
});
(v1.prototype) = ((v0) === (null)) ? (Object.create(v0)) : (((v3.prototype) = v0.prototype, new v3()));
