...
"use strict";
var v4 = v3(2), v5 = v3(26), v6 = v3(8), v7 = v3(135), v8 = v3(10), v9 = (v3(1), ({dangerouslyReplaceNodeWithMarkup : (function (v1, v2){
if(((v6.canUseDOM) ? (void 0) : (v4("56")), (v2) ? (void 0) : (v4("57")), (("HTML") === (v1.nodeName)) ? (v4("58")) : (void 0), ("string") == (typeof v2))){
var v3 = v7(v2, v8)[0];
v1.parentNode.replaceChild(v3, v1);
}else {
v5.replaceChildWithTree(v1, v2);
}
})}));
(v1.exports) = v9;
});
(v0.prototype.getOffset) = (function (){
return this._offset;
});
