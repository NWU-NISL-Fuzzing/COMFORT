...
return ((v1.expire_date) < (v2.expire_date)) ? (- 1) : (1);
});
var v1 = (function (v1, v2, v3){
var v4 = v3(316), v5 = v3(1029);
(v1.exports) = (function (v1, v2){
return ((v2.length) < (2)) ? (v1) : (v4(v1, v5(v2, 0, - 1)));
});
});
...
(this._description) = v1;
(this._argsDescription) = v2;
return this;
});
var v3 = (function (){
function v3(){
...
function v4(v1, v2){
var v3 = ({dx : v1.v, dv : v1(v1)}), v5 = v3(v1, (v2) * (0.5), v3), v7 = v3(v1, (v2) * (0.5), v5), v8 = v3(v1, v2, v7), v9 = ((1.0) / (6.0)) * (((v3.dx) + ((2.0) * ((v5.dx) + (v7.dx)))) + (v8.dx)), v10 = ((1.0) / (6.0)) * (((v3.dv) + ((2.0) * ((v5.dv) + (v7.dv)))) + (v8.dv));
(v1.x) = (v1.x) + ((v9) * (v2));
(v1.v) = (v1.v) + ((v10) * (v2));
return v1;
}
(v2.prototype._attachCameras) = (function (v1, v2){
...
if(v2){
return (v5) + ((v4(v1)) ? (v3(v3)[1]) : (v3(v3)[0]));
}else {
if(v4){
return (v5) + (v3(v3)[1]);
}else {
return (v5) + ((v4(v1)) ? (v3(v3)[1]) : (v3(v3)[2]));
}
}
}
}
