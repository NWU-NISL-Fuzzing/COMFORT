...
var v4 = v3(693), v5 = v3(241);
(v1.exports) = (function (v1){
for(var v2 = v5(v1), v3 = v2.length;v3--;){
var v6 = v2[v3], v7 = v1[v6];
(v2[v3]) = [];
}
return v2;
});
...
v0(/^(ox)en/i, "$1");
var v1 = (function (v1){
var v2 = v1.length, v3 = v1.constructor(v2);
...
var v2 = (function (v1){
this._setProperty('-webkit-perspective-origin-y', v1);
});
...
(v4._RemoveTagFrom) = (function (v1, v2){
delete v1._tags[v2];
});
