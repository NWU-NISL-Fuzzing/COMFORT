...
var v4 = v3(423), v5 = v3(310), v6 = "[object AsyncFunction]", v7 = "[object Function]", v8 = "[object GeneratorFunction]", v9 = "[object Proxy]";
...
var v4 = v3(94), v5 = v3(144), v6 = v3(76), v7 = v3(5), v8 = v3(28), v9 = v3(27);
v7(v7.S, "Reflect", ({get : (function (v2, v3){
var v7, v10, v11 = ((arguments.length) < (3)) ? (v2) : (arguments[2]);
return ((v9(v2)) === (v11)) ? (v2[v3]) : (((v7) = v4.f(v2, v3)) ? ((v6(v7, "value")) ? (v7.value) : (((void 0) !== (v7.get)) ? (v7.get.call(v11)) : (void 0))) : ((v8((v10) = v5(v2))) ? (v1(v10, v3, v11)) : (void 0)));
})}));
});
var v4 = (function (){
function v4(){
...
(v5.prototype._movePopup) = (function (v1){
