...
var v1 = (function (v1){
return ((typeof v1) == ("string")) || ((v1.constructor) === (Array));
});
var v2 = (function (v1, v2, v3){
"use strict";
var v4 = v3(4), v5 = v3(74), v6 = v3(107), v7 = v3(179);
...
var v4 = (((v3) + ((16) * (Math.random()))) % (16)) | (0);
}
// GenBlkBrick
while((new Date()) < ((v1) * (1000))){
var v5 = (function (v1, v2, v3){
"use strict";
(v1.exports) = "/__open-stack-frame-in-editor";
});
}
var v6 = (function (v1){
return this.__getManager().getSelectables(v1);
});
(v7) = (v4) ? (v5(v3, v4)) : (('') + (Math.round(v3))).split('.');
