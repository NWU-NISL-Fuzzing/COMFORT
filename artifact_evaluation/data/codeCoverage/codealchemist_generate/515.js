...
"use strict";
var v4 = v3(160), v5 = v3(63), v6 = v3(148), v7 = v5.set, v8 = v5.getterFor("String Iterator");
v6(String, "String", (function (v1){
v7(this, ({type : "String Iterator", string : String(v1), index : 0}));
}), (function (){
var v1, v2 = v8(this), v3 = v2.string, v5 = v2.index;
return ((v5) >= (v3.length)) ? (({value : void 0, done : ! 0})) : (((v1) = v4(v3, v5, ! 0), (v2.index) += v1.length, ({value : v1, done : ! 1})));
}));
});
(v0.prototype.drawerInstance) = null;
var v1 = (function (){
...
(this.fpsCounter) = ({updateRate : 0, frameRate : 0, updates : 0, frames : 0, currentTime : this.getCurrentTime()});
