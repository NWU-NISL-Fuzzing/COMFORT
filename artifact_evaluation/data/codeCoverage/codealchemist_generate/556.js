...
(this.stack) = new v1().stack;
return this;
}
(v3.prototype) = Object.create(v1.prototype);
...
if((v0) < ((2.5) / (2.75))){
(v0) = (((7.5625) * ((v0) -= (2.25) / (2.75))) * (v0)) + (0.9375);
}else {
(v0) = (((7.5625) * ((v0) -= (2.625) / (2.75))) * (v0)) + (0.984375);
}
...
(v5.prototype) = ((v3) === (null)) ? (Object.create(v3)) : (((v1.prototype) = v3.prototype, new v1()));
