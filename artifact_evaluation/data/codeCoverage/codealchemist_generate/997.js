...
(v1.features) = [];
v1.fire("featuresremoved", ({features : [], succeed : true}));
});
var v2 = (function (v1, v2, v3){
(v1.exports) = (v3.p) + ("add7cba32706afd5b69fb263af4a49e1.svg");
});
Object.defineProperty(v1.prototype, "size", ({get : (function (){
...
var v4 = v1('./Language');
(v2.exports) = (function (){
var v5 = ({feature : '(?:[Ff]eature|[Ff]unctionaliteit|[Ee]igenschap)', scenario : '(?:[Ss]cenario|[Gg|eval)', examples : '(?:[Vv]oorbeelden?)', pending : '(?:[Tt]odo|[Mm]oet nog)', only : '(?:[Aa]lleen)', background : '(?:[Aa]chtergrond)', given : '(?:[Ss]tel|[Gg]egeven(?:\\sdat)?|[Ee]n|[Mm]aar)', when : '(?:[Aa]ls|[Ww]anneer|[Ee]n|[Mm]aar)', then : '(?:[Dd]an|[Vv]ervolgens|[Ee]n|[Mm]aar)', _steps : []});
return new v4('Dutch', v5);
})();
});
var v6 = (function (){
function v6(){
