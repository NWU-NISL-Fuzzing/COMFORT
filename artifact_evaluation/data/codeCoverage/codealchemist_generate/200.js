...
var v7 = (v3) + (v3), v8 = (v4) + (v4), v9 = (v5) + (v5);
var v10 = (v3) * (v7), v11 = (v3) * (v8), v12 = (v3) * (v9);
var v13 = (v4) * (v8), v14 = (v4) * (v9), v15 = (v5) * (v9);
var v16 = (v6) * (v7), v17 = (v6) * (v8), v18 = (v6) * (v9);
(v2[0]) = (1) - ((v13) + (v15));
(v2[4]) = (v11) - (v18);
(v2[8]) = (v12) + (v17);
(v2[1]) = (v11) + (v18);
...
Object.defineProperty(v0.prototype, "bias", ({get : (function (){
return this._bias;
}), set : (function (v2){
(this._bias) = v2;
