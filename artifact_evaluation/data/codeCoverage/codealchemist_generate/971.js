...
var v4 = v3(2119), v5 = v3(477), v6 = v3(476), v7 = (v6) && (v6.isMap), v8 = (v7) ? (v5(v7)) : (v4);
(v1.exports) = v8;
});
(v0.CONSTRAINT) = "constraint";
(v0.prototype.hideControls) = (function (v1){
});
var v2 = (function (v1){
var v2 = (v1.FCarry) ? (0x80) : (0);
(v1.FCarry) = ((v1.registerA) & (1)) == (1);
(v1.registerA) = ((v1.registerA) >> (1)) | (v2);
(v1.FZero) = (v1.FSubtract) = (v1.FHalfCarry) = false;
});
var v3 = (function (){
function v3(){
}
