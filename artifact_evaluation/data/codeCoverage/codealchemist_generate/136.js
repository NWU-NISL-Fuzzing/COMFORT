var v0 = (function (v1){
v1.createPoints(false);
});
// GenBlkBrick
while(v0){
var v1 = (function (){
var v1 = (this.stashed()) || (this.advance());
switch(v1.type){
}
(this.prev) = v1;
(v1.lineno) = this.lineno;
return v1;
});
}
function v2(v1, v2){
...
Object.defineProperty(v0.prototype, "shaderCompilationTimeCounter", ({get : (function (){
