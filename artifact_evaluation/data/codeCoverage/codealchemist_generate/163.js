...
var v4 = v3(414);
(v1.exports) = (Object("z").propertyIsEnumerable(0)) ? (Object) : ((function (v1){
return (("String") == (v4(v1))) ? (v1.split("")) : (Object(v1));
}));
});
var v1 = (function (v1, v2){
(v1.exports) = ({flex : "flex-10FtK5 flex-3B1Tl4", vertical : "vertical-dBpEJN vertical-3X17r5 flex-3B1Tl4 directionColumn-2h-LPR flex-3B1Tl4", horizontal : "horizontal-V15fsF horizontal-2VE-Fw flex-3B1Tl4 directionRow-yNbSvJ flex-3B1Tl4", wrapper : "wrapper-1hFz4R", content : "content-1fMjil"});
});
(v1.prototype) = new v0();
function v2(v1, v2, v3){
var v4 = ({'mm' : (v2) ? ('минута_минуты_минут') : ('минуту_минуты_минут'), 'hh' : 'час_часа_часов', 'dd' : 'день_дня_дней', 'MM' : 'месяц_месяца_месяцев', 'yy' : 'год_года_лет'});
if((v3) === ('m')){
return (v2) ? ('минута') : ('минуту');
}else {
return ((v1) + (' ')) + (v1(v4[v3], + v1));
}
}
(v2.parse) = v1.parse;
var v3 = (function (v1){
