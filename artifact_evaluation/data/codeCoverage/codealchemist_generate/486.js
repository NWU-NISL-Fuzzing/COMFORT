...
"use strict";
var v4 = v3(15), v5 = v3(1874), v6 = v3(1857).getConfiguration, v7 = v3(29), v8 = v3(25), v9 = v3(156), v10 = ({});
...
var v1 = (function (){
var v1 = this.getIterator();
var v2 = v1.meta('item');
var v3 = (this.lCenterX_) + ((v2.x) * (this.lScale_));
var v4 = (this.lCenterY_) + ((v2.y) * (this.lScale_));
return ({'value' : ({'x' : v3, 'y' : v4})});
});
(v1.parse) = v0.parse;
(v1.prototype.incrementReferences) = (function (){
this._references++;
});
(v0.POSITION_UNAVAILABLE) = 2;
var v2 = (function (v1){
return ({type : "AFTER_BINOP", op : v1});
});
var v3 = (function (){
function v3(){
}
