var v0 = (function (v1){
this._setProperty('stroke-linecap', v1);
});
var v1 = (function (v1){
return v1.replace(/@.*$/, '');
});
...
(v3.prototype.toCSS) = (function (v1){
var v2 = [];
...
var v5 = (function (v1){
var v2 = v1('https://management.azure.com:443').get('/subscriptions/947d47b4-7883-4bb9-9d85-c5e8e2f572ce/providers/Microsoft.Network/locations/westus.validation/operations/83b9f405-a959-482f-9ef3-67658cac4460?api-version=2017-10-01').reply(200, "{\r\n  \"status\": \"Succeeded\"\r\n}", ({'cache-control' : 'no-cache', pragma : 'no-cache', 'content-length' : '29', 'content-type' : 'application/json; charset=utf-8', expires : '-1', 'x-ms-request-id' : '75f79fda-5d85-4879-9072-08a8a33df768', 'strict-transport-security' : 'max-age=31536000; includeSubDomains', server : 'Microsoft-HTTPAPI/2.0', 'x-ms-ratelimit-remaining-subscription-reads' : '14987', 'x-ms-correlation-request-id' : '0164d966-5a05-4792-84f3-554b2f48b6b5', 'x-ms-routing-request-id' : 'WESTEUROPE:20171002T172718Z:0164d966-5a05-4792-84f3-554b2f48b6b5', date : 'Mon, 02 Oct 2017 17:27:18 GMT', connection : 'close'}));
return v2;
});
function v6(v1, v2){
(v2) = (v2) || (({}));
