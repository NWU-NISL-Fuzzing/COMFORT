...
var v1 = (function (v1){
var v2 = v1('https://management.azure.com:443').get('/subscriptions/947d47b4-7883-4bb9-9d85-c5e8e2f572ce/resourceGroups/xplat-test-peering/providers/Microsoft.Network/expressRouteCircuits/expressRouteCircuitName/peerings?api-version=2017-10-01').reply(200, "{\r\n  \"value\": []\r\n}", ({'cache-control' : 'no-cache', pragma : 'no-cache', 'content-length' : '19', 'content-type' : 'application/json; charset=utf-8', expires : '-1', 'x-ms-request-id' : '3ed449af-db86-4f77-bd19-537b5a45d913', 'strict-transport-security' : 'max-age=31536000; includeSubDomains', server : 'Microsoft-HTTPAPI/2.0', 'x-ms-ratelimit-remaining-subscription-reads' : '14999', 'x-ms-correlation-request-id' : '5e6ca9a0-f3ea-4464-85af-43f439367019', 'x-ms-routing-request-id' : 'WESTEUROPE:20170927T113255Z:5e6ca9a0-f3ea-4464-85af-43f439367019', date : 'Wed, 27 Sep 2017 11:32:55 GMT', connection : 'close'}));
return v2;
});
(v1.prototype) = new v0();
// GenBlkBrick
...
if((v1.class_tsid) == ('homestreet_ticket')){
return true;
}
return false;
});
