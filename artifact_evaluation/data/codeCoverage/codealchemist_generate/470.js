...
this.source.unshift(this.wrap(v1, v2));
});
// GenBlkBrick
...
Object.defineProperty(Object.prototype, "constructor", ({get : v2, set : v3, configurable : true}));
(v4) %= v1;
...
Array.prototype.reduce.call(v0, v3, v1);
var v5 = ((v4) + (':')) + (v1);
