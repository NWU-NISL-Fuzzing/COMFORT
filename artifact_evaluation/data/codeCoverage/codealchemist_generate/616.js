var v0 = (function (v1){
var v2 = v1.getSpanningFilesInfo();
var v3, v4;
for(var v5 = 0;(v5) < (v2.length);v5++){
(v3) = v2[v5];
(v4) = this.getFile(v3.fileNum);
v4.set('downloaded', (v4.get('downloaded')) + (v3.size));
var v6 = (v4.get('downloaded')) / (v4.size);
v4.set('complete', v6);
if((v6) == (1)){
v4.trigger('complete');
}
...
var v1 = (function (){
var v1 = [];
Object.defineProperty(v1, "prop", ({value : 2010, writable : true, enumerable : true, configurable : false}));
var v3 = (v1.prop) === (2010);
(v1.prop) = 1001;
return (v3) && ((v1.prop) === (1001));
});
var v2 = (function (v1, v2){
var v3 = ({});
(v3[v1]) = v2;
return this.addRegions(v3)[v1];
});
// GenBlkBrick
for(var v3 = 0;(v3) < (v1);(v3) += 3){
(v0.prototype.onSelectionCleared) = (function (){
});
}
(v0.prototype.visitLambda) = (function (v1){
...
(v1.exports) = (v3.p) + ("6e829dbdc26783477c653d4a6fd6587c.svg");
});
function v6(v1, v2){
var v3 = ({dx : v1.v, dv : v0(v1)}), v5 = v4(v1, (v2) * (0.5), v3), v7 = v4(v1, (v2) * (0.5), v5), v8 = v4(v1, v2, v7), v9 = ((1.0) / (6.0)) * (((v3.dx) + ((2.0) * ((v5.dx) + (v7.dx)))) + (v8.dx)), v10 = ((1.0) / (6.0)) * (((v3.dv) + ((2.0) * ((v5.dv) + (v7.dv)))) + (v8.dv));
(v1.x) = (v1.x) + ((v9) * (v2));
(v1.v) = (v1.v) + ((v10) * (v2));
return v1;
}
