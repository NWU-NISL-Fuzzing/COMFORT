...
(v1.tag.index) = this.getIterator().getIndex();
}
});
var v2 = (function (v1, v2){
var v3;
if(((((6) <= (v2)) && ((v2) < (8))) && ((0) <= (v1))) && ((v1) < (7))){
(v3) = ".";
}else {
if(((((v2) - (15)) * ((v2) - (15))) + (((v1) - (1)) * ((v1) - (1)))) < (2)){
(v3) = "^";
}else {
if(((((v2) - (40)) * ((v2) - (40))) + (((v1) - (6)) * ((v1) - (6)))) < (6)){
(v3) = "%";
}else {
if(((((v2) - (1)) * ((v2) - (1))) + (((v1) - (12)) * ((v1) - (12)))) < (2)){
(v3) = "@";
}else {
(v3) = " ";
}
...
var v4 = v3(24), v5 = v3(79), v6 = v3(40)("species");
...
Array.prototype.reduce.call(v4, v2, v3);
}
var v5 = (v3) * (v6);
(v7) = (function (v1, v2){
