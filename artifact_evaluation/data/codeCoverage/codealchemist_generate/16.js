...
(v1.default) = ({name : "ember-data", initialize : v2.default});
});
var v2 = (function (v1){
(this.size) = v1;
(this.startTiles) = 2;
...
(v3.prototype.visitInvoke) = (function (v1){
return v1.update(this.visit(v1.expression), this.visitMany(v1.args));
});
function v4(v1, v2){
(v2) = (v2) || (({}));
var v3 = '';
