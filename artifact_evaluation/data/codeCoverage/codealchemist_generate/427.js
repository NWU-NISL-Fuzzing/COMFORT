...
var v4 = v3(0);
v4((v4.S) + ((v4.F) * (! v3(14))), "Object", ({defineProperty : v3(15).f}));
});
var v1 = (function (v1){
return v1.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
});
(v1.prototype.getShadowMap) = (function (){
...
var v4 = v1('./plot_api');
(v3.plot) = v4.plot;
(v3.newPlot) = v4.newPlot;
(v3.restyle) = v4.restyle;
(v3.relayout) = v4.relayout;
(v3.redraw) = v4.redraw;
(v3.update) = v4.update;
(v3._guiRestyle) = v4._guiRestyle;
(v3._guiRelayout) = v4._guiRelayout;
(v3._guiUpdate) = v4._guiUpdate;
(v3._storeDirectGUIEdit) = v4._storeDirectGUIEdit;
(v3.react) = v4.react;
(v3.extendTraces) = v4.extendTraces;
(v3.prependTraces) = v4.prependTraces;
(v3.addTraces) = v4.addTraces;
(v3.deleteTraces) = v4.deleteTraces;
(v3.moveTraces) = v4.moveTraces;
(v3.purge) = v4.purge;
(v3.addFrames) = v4.addFrames;
(v3.deleteFrames) = v4.deleteFrames;
(v3.animate) = v4.animate;
(v3.setPlotConfig) = v4.setPlotConfig;
(v3.toImage) = v1('./to_image');
(v3.validate) = v1('./validate');
(v3.downloadImage) = v1('../snapshot/download');
var v5 = v1('./template_api');
(v3.makeTemplate) = v5.makeTemplate;
(v3.validateTemplate) = v5.validateTemplate;
});
