var v0 = (function (v1){
var v2 = this, v3 = v2.getParsedDatesFromInputValue(), v4 = v2.getParsedDatesFromInputValue(v1.result.raw);
...
if((((this.getContainerType()) == ('street')) && (this.container.pols_is_pol())) && (! this.container.pols_is_owner(v1))){
return ({state : null});
}
if(! this.canVend()){
return ({state : null});
...
return ({state : 'disabled', reason : "There's nothing to collect."});
}
