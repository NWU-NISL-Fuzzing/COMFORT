...
var v2 = v1.context;
var v3 = v2.canvas;
var v4 = v1.frameState.pixelRatio;
v2.save();
var v5 = (this.pattern.canvas.width) * (v4);
var v6 = v1.frameState.extent;
var v7 = (v1.frameState.viewState.resolution) / (v4);
var v8 = [];
var v9 = this.internal_.getContext("2d");
var v10 = (this.internal_.width) = v3.width;
var v11 = (this.internal_.height) = v3.height;
(v9.webkitImageSmoothingEnabled) = (v9.mozImageSmoothingEnabled) = (v9.msImageSmoothingEnabled) = (v9.imageSmoothingEnabled) = false;
var v12 = Math.floor(((v10) - (v8[0])) / (v5));
var v14 = Math.floor(((v11) - (v8[1])) / (v5));
v9.drawImage(v3, v8[0], v8[1], (v12) * (v5), (v14) * (v5), 0, 0, v12, v14);
(v2.webkitImageSmoothingEnabled) = (v2.mozImageSmoothingEnabled) = (v2.msImageSmoothingEnabled) = (v2.imageSmoothingEnabled) = false;
v2.clearRect(0, 0, v10, v11);
v2.drawImage(this.internal_, 0, 0, v12, v14, v8[0], v8[1], (v12) * (v5), (v14) * (v5));
v2.scale(v4, v4);
(v2.fillStyle) = this.getPattern((v8[0]) / (v4), (v8[1]) / (v4));
v2.rect(0, 0, v10, v11);
v2.fill();
v2.restore();
});
