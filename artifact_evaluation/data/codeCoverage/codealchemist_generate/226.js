...
(v1.exports) = (v3.p) + ("d68327d74508465432fe6e9dee35b9ff.svg");
});
(v0[0]) = 11;
var v1 = (function (v1, v2, v3){
(v1.exports) = (v3.p) + ("d52f627e931d2dbcf8e1683480f617f7.svg");
});
var v2 = (function (v1, v2, v3){
(v1.exports) = (v3.p) + ("f78426a064bc9dd24847519259bc42af.png");
});
v0(v1, v2);
var v3 = (function (v1, v2, v3){
var v4 = v3(5);
v4(v4.S, "Math", ({log1p : v3(503)}));
});
var v4 = (function (){
function v4(){
}
...
var v5 = (function (v1){
var v2 = v1('http://management.core.windows.net:443').get('/00977cdb-163f-435f-9c32-39ec8ae61f4d/services/WebSpaces/xDeploymentTestGroup5153-WestUSwebspace/sites?propertiesToInclude=repositoryuri%2Cpublishingpassword%2Cpublishingusername').reply(200, "<Sites xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"/>", ({'cache-control' : 'private', 'content-length' : '110', 'content-type' : 'application/xml; charset=utf-8', server : '1.0.6198.405 (rd_rdfe_stable.160723-1634) Microsoft-HTTPAPI/2.0', 'x-ms-servedbyregion' : 'ussouth3', 'strict-transport-security' : 'max-age=31536000; includeSubDomains', 'x-aspnet-version' : '4.0.30319', 'x-powered-by' : 'ASP.NET', 'x-ms-request-id' : '8360ae6ab0660ac99236fd39f01cd217', date : 'Tue, 02 Aug 2016 19:57:16 GMT', connection : 'close'}));
return v2;
});
