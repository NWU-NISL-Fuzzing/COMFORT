...
(v1.exports) = (v3.p) + ("738f1344257a39708b4a1c092ed4d983.svg");
});
var v2 = (function (){
this._outgoingRoomKeyRequestManager.stop();
this._deviceList.stop();
});
(v2.prototype.render) = (function (v1){
if(v1){
v1(this._opaqueSubMeshes, this._alphaTestSubMeshes, this._transparentSubMeshes);
return true;
}
...
v2.setAlphaTesting(true);
this._renderAlphaTest(this._alphaTestSubMeshes);
v2.setAlphaTesting(false);
if(this.onBeforeTransparentRendering){
this.onBeforeTransparentRendering();
}
