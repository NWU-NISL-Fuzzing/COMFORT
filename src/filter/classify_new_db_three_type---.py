...
if __name__ == '__main__':
    db_path = r"F:\Download\qx_1st\result-2020-05-20-test.db"
    ...
    differential_test_result = db.query("SELECT bugType, output_id FROM NoExceptionResults")
    print(len(differential_test_result))
    for info in tqdm.tqdm(differential_test_result):
        suspicious_results = []
